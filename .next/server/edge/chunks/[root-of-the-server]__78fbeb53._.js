(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root-of-the-server]__78fbeb53._.js", {
...
class Auth0Integration {
   ...
   */ static async getAuth0Session(request) {
        try {
            ...
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$auth0$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["auth0"].getSession(request);
            ...
            // Get access token
            const accessTokenResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$auth0$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["auth0"].getAccessToken();
            return {
   ...
   */ static async updateUserMetadata(userId, metadata) {
        try {
            ...
            const response = await fetch(`${process.env.AUTH0_ISSUER_BASE_URL}/api/v2/users/${encodeURIComponent(userId)}`, {
                method: 'PATCH',
                headers: {
...
async function middleware(request) {
    ...
    if (pathname.startsWith('/auth')) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$auth0$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["auth0"].middleware(request);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78fbeb53._.js.map