...
export function AddressValidation({ className }: AddressValidationProps) {
  ...
  return (
    <QAPageTemplate
      title="AddressValidation - Coming Soon"
    ...
    >
      <div className="text-center p-8">
        ...
        <p className="text-gray-500">Page: address-validation</p>
        <p className="text-gray-400 text-sm mt-2">Component: AddressValidation</p>
      </div>
    </QAPageTemplate>
  );
}