...
export interface EatingDisorderSafetyWarningProps {
  className?: string;
}

export function EatingDisorderSafetyWarning({ className }: EatingDisorderSafetyWarningProps) {
  ...
  return (
    <QAPageTemplate
      title="EatingDisorderSafetyWarning - Coming Soon"
    ...
    >
      <div className="text-center p-8">
        ...
        <p className="text-gray-500">Page: eating-disorder-safety-warning</p>
        <p className="text-gray-400 text-sm mt-2">Component: EatingDisorderSafetyWarning</p>
      </div>
    </QAPageTemplate>
  );
}