...
const ADDITIONAL_COMORBIDITIES_PART_C_OPTIONS = [
...
export interface AdditionalComorbiditiesPartCProps {
    className?: string;
}
...
export function AdditionalComorbiditiesPartC({ className }: AdditionalComorbiditiesPartCProps) {
    return (
        <CheckboxAssessment
            ...
            options={ADDITIONAL_COMORBIDITIES_PART_C_OPTIONS}
            fieldName="q4_patient_comorbidities_white_part_c"
